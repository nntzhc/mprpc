...
inline const std::string& LoginRequest::passwd() const {
  // @@protoc_insertion_point(field_get:fixbug.LoginRequest.passwd)
...
void LoginRequest::set_passwd(ArgT0&& arg0, ArgT... args) {
 ...
 passwd_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:fixbug.LoginRequest.passwd)
}
inline std::string* LoginRequest::mutable_passwd() {
  std::string* _s = _internal_mutable_passwd();
  // @@protoc_insertion_point(field_mutable:fixbug.LoginRequest.passwd)
  return _s;
}
...
inline std::string* LoginRequest::release_passwd() {
  // @@protoc_insertion_point(field_release:fixbug.LoginRequest.passwd)
...
inline void LoginRequest::set_allocated_passwd(std::string* passwd) {
  ...
  passwd_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), passwd,
      GetArenaForAllocation());
  // @@protoc_insertion_point(field_set_allocated:fixbug.LoginRequest.passwd)
}
